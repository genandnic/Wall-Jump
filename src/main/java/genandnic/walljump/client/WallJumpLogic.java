...
public class WallJumpLogic {
    ...
    public static void doWallJump(ClientPlayerEntity pl) {
        ...
        if (Config.COMMON.autoRotation.get()) pl.rotationYaw = getClingDirection().getOpposite().getHorizontalAngle();
    ...
    private static boolean canWallCling(ClientPlayerEntity pl) {
        ...
        if (Config.COMMON.allowReClinging.get() || pl.getPositionVec().y < lastJumpY - 1) return true;
