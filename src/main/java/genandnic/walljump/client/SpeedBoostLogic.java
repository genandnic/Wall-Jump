    ...
    public static void doSpeedBoost(ClientPlayerEntity pl) {
        ...
        if (pl.isElytraFlying()) {
            ...
            if (pl.isCrouching()) {
                ...
                float elytraSpeedBoost = Config.COMMON.elytraSpeedBoost.get().floatValue() + (getEquipmentBoost(pl,EquipmentSlotType.CHEST) * 0.75f);
            ...
            float sprintSpeedBoost = (Config.COMMON.sprintSpeedBoost.get().floatValue() + (getEquipmentBoost(pl, EquipmentSlotType.FEET) * 0.375f));
